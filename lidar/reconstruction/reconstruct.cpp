...
#include </home/harsh/catkin_ws/devel/include/clustering/CoordinateList.h>
#include </home/harsh/catkin_ws/devel/include/clustering/Coordinates.h>
#include<bits/stdc++.h>
...
void 
cluster_cb (clustering::CoordinateList inputclusters)
{
  clusters.clear();
...
cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input)
{
  ...
  ROS_INFO("Publishing to reconstructedcluster");
  pub.publish (*reconstructedcloud);
}
